...
document.querySelector('.search-box').addEventListener('submit', async function(e) {
    ...
    try {
        const response = await fetch('nurota-toponim.json', {
            method: 'POST',
            headers: {
        ...
        if (response.ok) {
            ...
            console.log('Qidiruv natijalari:', result);
        }
    } catch (error) {
